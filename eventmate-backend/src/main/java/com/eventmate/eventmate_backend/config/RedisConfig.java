 ...
 * - TTL: 5 minutes for all caches (events, etc.)
 * - Serialization: JSON (human-readable, avoids class-cast issues)
...
public class RedisConfig {
    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        // Configure Jackson to serialize Java types (including LocalDate etc.) correctly
